...
function ntc_admin_page() {
    ...
    <div class="wrap">
        ...
        <div id="ntc-settings" style="margin-bottom:15px;">
            ...
            <span style="color:#888;">(default 20 – recommended)</span>
        </div>
    ...
    function processBatch() {
        ...
        fetch(ajaxurl + '?action=ntc_process_batch&last_id=' + lastId + '&batch_size=' + batchSize)
        ...
        .then(data => {
            if (data.success) {
                ...
                if (!data.data.finished) {
                    setTimeout(processBatch, 200); // next batch
                } else {
